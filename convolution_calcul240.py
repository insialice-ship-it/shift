#The same program as "convolution.py" with the exception that the imput file name is "cdspectrum_shifted_calcul240" and the output file name is 'convolution_calcul240.png'
...
data = np.loadtxt('cdspectrum_shifted_calcul240')
...
plt.savefig("convolution_calcul240.png", dpi=300) 
plt.show()
